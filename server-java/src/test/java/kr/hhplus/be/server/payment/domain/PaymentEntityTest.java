...
class PaymentEntityTest {
    ...
    void shouldConvertToDomain() {
        ...
        PaymentEntity entity = new PaymentEntity(
                id, orderId, userId, idempotencyKey, PaymentType.POINT,
        ...
        assertThat(domain.getIdempotencyKey()).isEqualTo(idempotencyKey);
    ...
    void shouldConvertFromDomain() {
        ...
        UUID userId = UUID.randomUUID();
        String idempotencyKey = UUID.randomUUID().toString();
        Payment domain = new Payment(orderId, userId, idempotencyKey, 50000L, 50000L);
    ...
    void shouldMaintainConsistencyInBidirectionalConversion() {
        ...
        UUID userId = UUID.randomUUID();
        String idempotencyKey = UUID.randomUUID().toString();
        Payment originalDomain = new Payment(orderId, userId, idempotencyKey, 50000L, 50000L);
        ...
        assertThat(convertedDomain.getIdempotencyKey()).isEqualTo(originalDomain.getIdempotencyKey());
